...
export const getBookByRecommendedAction = "GET_BOOK_BY_RECOMMENDED"
export const getBookByRecommendedIdAction = "GET_BOOK_BY_RECOMMENDED_ID"
export const getBookByPageAction = "GET_BOOK_BY_PAGE"
export const getBookBySearchIdAction = "GET_BOOK_BY_SEARCH_ID"
export const getBookBySearchAction = "GET_BOOK_BY_SEARCH"
export const getBookBySearchPageAction = "GET_BOOK_BY_SEARCH_PAGE"
export const deleteBookBySearchAction = "DELETE_BOOK_BY_SEARCH"
export const getBookByGenreAction = "GET_BOOK_BY_GENRE"
export const getBookByGenreIdAction = "GET_BOOK_BY_GENRE_ID"
export const getBookByGenrePageAction = "GET_BOOK_BY_GENRE_PAGE"
export const deleteBookByGenreAction = "DELETE_BOOK_BY_GENRE"
